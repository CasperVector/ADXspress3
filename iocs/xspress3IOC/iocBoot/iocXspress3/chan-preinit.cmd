NDROIConfigure("ROI$(CHAN)", $(QSIZE), 0, "$(PORT)", 0, 0, 0)
NDStdArraysConfigure("MCA$(CHAN)", 20, 0, "ROI$(CHAN)", 0, 0)
NDROIConfigure("ROISUM$(CHAN)", $(QSIZE), 0, "PROC1", 0, 0, 0)
NDStdArraysConfigure("MCASUM$(CHAN)", 20, 0, "ROISUM$(CHAN)", 0, 0)
