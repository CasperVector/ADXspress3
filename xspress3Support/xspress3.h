...
int 	xsp3_config_init(int ncards, int num_tf, char* baseIPaddress, int basePort, char* baseMACaddress, int num_chan,	int create_module, char* modname, int debug, int card_index, 
			int do_init, Xsp3mReadoutMode xsp3m_readout, XspressDummy dummy_system);
...
#define XSP3_FEATURE_OUTPUT_FORMAT_HEIGHTS64TS48	4		//!< Output is list of 64 bit words including processed event height and all auxiliary info and timestamps
...
#define XSP3_HGT64TS48_GET_TS_FULL(x)				((x)&0xFFFFFFFFFFFFL)			//!< Get full 48 bit time stam.
#define XSP3_HGT64TS48_TS_TOP					0xFFFFFFFE0000L			//!< Get full 48 bit time stam.
#define XSP3_HGT64TS48_TS_MID					0x00001FFE0000L			//!< Get full 48 bit time stam.
